...
namespace SplinesDataStructures
{
    ...
    public class SplineData
    {
        ...
        private const string SplinesCalculatorDllPath = "E:\\MSU\\Programming\\C#\\Lab1\\x64\\Debug\\SplinesCalculator.dll";
        ...
        public void CalculateSpline()
        {
            ...
            if (RawData.Left > RawData.Right || RawData.NodesCount < 1 || SplineNodesCount < 1)
            {
                throw new Exception("Inappropriate parameters");
            }
